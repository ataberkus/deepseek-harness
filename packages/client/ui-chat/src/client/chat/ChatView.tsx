 ...
 *
 * Checkpoints are ordered by the Host's boundary sequence, but branch
 * checkpoints are delivered separately for child sessions, so both sources
 * participate in the nearest-preceding selection.
 */
...
export function ChatView({
  useSession, useChat, useSessions, inputActions, useStore, actions, renderSlot,
