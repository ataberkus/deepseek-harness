...
describe('ChatView', () => {
  ...
  it('chooses the nearest preceding checkpoint for the edited user message', () => {
    const h = makeHarness({
  ...
  it('uses a ready branch checkpoint for an edited user message', () => {
    const h = makeHarness({
      nodes: [user(4, 'replacement')],
      checkpoints: {
        enabled: true,
        checkpoints: [{
          id: 'initial', sessionId: SID, boundarySeq: -1, labelIndex: 0, role: 'initial',
        ...
        branchCheckpoint: {
          id: 'lineage', sessionId: 'source' as SessionId, boundarySeq: 3, labelIndex: 1, role: 'turn',
          status: { kind: 'ready' }, restoreEligible: true, fileCount: 1, createdAt: 1,
        },
        workspaceResumable: true,
      } as never,
