...
import type {
  ComposerKeyboard, ConversationEditDraft, DraftAttachmentId, InputTriggerController, SessionInputResolver, SessionInput,
...
export class InputHub implements SessionInputResolver {
  ...
  shellFor(binding: SessionBinding): SessionInputShell {
    ...
    const shell = new SessionInputShell({
      ...
      defaultSink: (text, imageIds, mode, signal, edit) => this.sink(session, text, imageIds, mode, signal, edit),
