...
export const zh = {
  ...
  'stats.cost': '花费 {cost}',
  'stats.costWithSubagents': '花费 {cost}（本会话 {own}）',
  ...
  'message.edit': '编辑并重新运行',
  'message.editImagesUnsupported': '编辑消息时请先移除当前草稿中的图片附件',
  'message.edit.banner': '正在编辑这条消息',
  'message.edit.cancel': '取消编辑',
...
export const en = {
  ...
  'stats.costWithSubagents': 'Cost {cost} (own {own})',
  ...
  'message.edit': 'Edit and rerun',
  'message.editImagesUnsupported': 'Remove draft image attachments before editing this message',
  'message.edit.banner': 'Editing this message',
  'message.edit.cancel': 'Cancel edit',
