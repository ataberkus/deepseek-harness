...
export const zh = {
  ...
  'stats.estimatedCost': '预计费用 {cost}',
  'stats.approximateCost': '近似费用 {cost}',
  'stats.costUnavailable': '预计费用不可用',
...
export const en = {
  ...
  'stats.estimatedCost': 'Estimated cost {cost}',
  'stats.approximateCost': 'Approx. cost {cost}',
  'stats.costUnavailable': 'Estimated cost unavailable',
