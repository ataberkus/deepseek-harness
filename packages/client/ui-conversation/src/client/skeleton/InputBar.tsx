...
export const InputBar = memo(function InputBar({
  ...
  const workspaceUnavailable = checkpointSnapshot?.enabled === true
    && checkpointSnapshot.workspaceResumable === false
  ...
  const plainMessageDraft = editTarget === undefined && !empty && input?.phase === 'plain' && !draft.trimStart().startsWith('/')
