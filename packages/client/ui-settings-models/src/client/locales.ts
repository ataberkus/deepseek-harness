...
export const en = {
  ...
  oauthConfigured: 'Signed in with ChatGPT',
  oauthConfiguredCursor: 'Signed in with Cursor',
  oauthConfiguredAntigravity: 'Signed in with Antigravity',
  oauthConfiguredGemini: 'Signed in with Antigravity',
  oauthSignOut: 'Delete',
  oauthSignOutProvider: 'Delete {provider}',
  oauthSignOutTitle: 'Sign out of {provider}?',
  oauthSignOutDescription: 'Signing out of {provider} deletes the stored login. Sign in again from this page or with /login from the composer.',
  oauthSignOutConfirm: 'Sign out of {provider}',
  oauthSigningOut: 'Signing out of {provider}…',
  oauthConnect: 'Connect',
  oauthConnectProvider: 'Connect {provider}',
  oauthConnecting: 'Connecting {provider}…',
  oauthConnectDescription: 'Sign in with {provider} in your browser to use its models here.',
  apiKeyLoginConfigured: 'API key connected',
  apiKeyConnectDescription: 'Enter your {provider} API key to use its models here.',
  apiKeyInputProvider: '{provider} API key',
  apiKeyDisconnectTitle: 'Disconnect {provider}?',
  apiKeyDisconnectDescription: 'Disconnecting {provider} deletes its stored API key. Connect it again from this page.',
  apiKeyDisconnectConfirm: 'Disconnect {provider}',
  apiKeyDisconnecting: 'Disconnecting {provider}…',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  oauthConfigured: '已使用 ChatGPT 登录',
  oauthConfiguredCursor: '已使用 Cursor 登录',
  oauthConfiguredAntigravity: '已使用 Antigravity 登录',
  oauthConfiguredGemini: '已使用 Antigravity 登录',
  oauthSignOut: '删除',
  oauthSignOutProvider: '删除 {provider}',
  oauthSignOutTitle: '退出 {provider} 登录？',
  oauthSignOutDescription: '退出 {provider} 会删除已存储的登录。之后可在此页或在对话输入框用 /login 再次登录。',
  oauthSignOutConfirm: '退出 {provider} 登录',
  oauthSigningOut: '正在退出 {provider} 登录…',
  oauthConnect: '连接',
  oauthConnectProvider: '连接 {provider}',
  oauthConnecting: '正在连接 {provider}…',
  oauthConnectDescription: '在浏览器中使用 {provider} 登录，即可在此使用其模型。',
  apiKeyLoginConfigured: 'API 密钥已连接',
  apiKeyConnectDescription: '输入 {provider} API 密钥，即可在此使用其模型。',
  apiKeyInputProvider: '{provider} API 密钥',
  apiKeyDisconnectTitle: '断开 {provider}？',
  apiKeyDisconnectDescription: '断开 {provider} 会删除已存储的 API 密钥。之后可在此页面重新连接。',
  apiKeyDisconnectConfirm: '断开 {provider}',
  apiKeyDisconnecting: '正在断开 {provider}…',
