...
export const en = {
  ...
  oauthSignOutDescription: 'Signing out of {provider} deletes the stored login. Sign in again with /login from the composer.',
  ...
  fetchSearch: 'Search models',
  fetchSelectNone: 'Deselect all',
  fetchNoneMatch: 'No models match this search.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  oauthSignOutDescription: '退出 {provider} 会删除已存储的登录。之后可在对话输入框用 /login 再次登录。',
  ...
  fetchAdopt: '添加所选',
  fetchSearch: '搜索模型',
  fetchSelectNone: '取消全选',
  fetchNoneMatch: '没有匹配此搜索的模型。',
  customAdd: '添加自定义提供方',
  customTitle: '自定义提供方',
  customTag: '自定义',
  customRoute: 'Provider ID',
