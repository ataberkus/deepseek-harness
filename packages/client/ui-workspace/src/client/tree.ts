  ...
  return {
    items: ordered.slice(0, limit).map((summary) => {
      ...
      return {
        ...
        ...(summary.checkpointLabelIndex === undefined ? {} : { checkpointLabelIndex: summary.checkpointLabelIndex }),
        ...(summary.workspaceResumable === undefined ? {} : { workspaceResumable: summary.workspaceResumable }),
