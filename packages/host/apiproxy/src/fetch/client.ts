...
export interface IApiClient {
  sessions: {
    ...
    edit(payload: RequestPayload<'session.edit'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'session.edit'>>>
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'session.edit': sessionEditValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly sessions: IApiClient['sessions'] = {
    ...
    edit: (payload, signal) => this.callUnary('session.edit', payload, signal),
