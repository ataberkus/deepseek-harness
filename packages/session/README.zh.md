...
| 包 | 职责 | ctx 键 |
|---|---|---|
| [`workspace-checkpoint/`](workspace-checkpoint/README.zh.md) | 定义捕获、恢复、租约与保留策略服务 | `ctx.workspaceCheckpoint` |
| [`workspace-checkpoint-local/`](workspace-checkpoint-local/README.zh.md) | 在 Harness 主目录中保存清单和内容寻址对象 | 注册 `ctx.workspaceCheckpoint` |
| [`workspace-checkpoint-capture/`](workspace-checkpoint-capture/README.zh.md) | 捕获初始及已结算回合检查点，并安装恢复保护 | 包装 `ctx.llm` 和 `ctx.tools` |
